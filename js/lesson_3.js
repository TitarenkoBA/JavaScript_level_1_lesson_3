...
/*
var a = ['носки', 'трусы', 'шапка', 'штаны', 'куртка', 'шарф']; // Каталог товаров магазина
var b = [100, 200, 500, 1000, 3000, 300];						// Цены на товары из каталога магазина
var c = [];														// Корзина
var d = 1;
var e = 0;

while ((d > 0 && d <= 6) && isNaN (d) != true) {
	d = + prompt ('Товары в корзине ' + c + '\n1 - носки, 2 - трусы, 3 - шапка, 4 - штаны, 5 - куртка, 6 - шарф \n0 - выход');
	if ((d > 0 && d <= 6) && isNaN (d) != true) {
		c.push (d);
	} 
} 

console.log ('Корзина: ' + c);
...
countBasketPrice ();
console.log (e);
// Было бы больше времени, сделал бы все лучше и компактнее, и логику бы изменил.
*/
